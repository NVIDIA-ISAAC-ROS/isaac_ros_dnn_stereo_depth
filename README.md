...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [DNN Stereo Disparity Graph](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/benchmarks/isaac_ros_ess_benchmark/scripts/isaac_ros_ess_graph.py)<br/><br/><br/>Full<br/><br/>        | 576p<br/><br/>         | [157 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_ess_graph-agx_thor.json)<br/><br/><br/>13 ms @ 30Hz<br/><br/>        | [68.5 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_ess_graph-thor-t4000.json)<br/><br/><br/>38 ms @ 30Hz<br/><br/>      | [150 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_ess_graph-dgx_spark.json)<br/><br/><br/>13 ms @ 30Hz<br/><br/>       | [347 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_ess_graph-x86-5090.json)<br/><br/><br/>9.9 ms @ 30Hz<br/><br/>       |
| [DNN Stereo Disparity Graph](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/benchmarks/isaac_ros_ess_benchmark/scripts/isaac_ros_light_ess_graph.py)<br/><br/><br/>Light<br/><br/> | 288p<br/><br/>         | [285 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_light_ess_graph-agx_thor.json)<br/><br/><br/>9.2 ms @ 30Hz<br/><br/> | [155 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_light_ess_graph-thor-t4000.json)<br/><br/><br/>20 ms @ 30Hz<br/><br/> | [231 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_light_ess_graph-dgx_spark.json)<br/><br/><br/>11 ms @ 30Hz<br/><br/> | [349 fps](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_benchmark/blob/release-4.5/results/isaac_ros_light_ess_graph-x86-5090.json)<br/><br/><br/>9.2 ms @ 30Hz<br/><br/> |
...
* [`isaac_ros_dnn_stereo_decoder`](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_dnn_stereo_depth/isaac_ros_dnn_stereo_decoder/index.html)
  * [Quickstart](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_dnn_stereo_depth/isaac_ros_dnn_stereo_decoder/index.html#quickstart)
  * [Troubleshooting](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_dnn_stereo_depth/isaac_ros_dnn_stereo_decoder/index.html#troubleshooting)
  * [API](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_dnn_stereo_depth/isaac_ros_dnn_stereo_decoder/index.html#api)
...
Update 2026-07-06: Added DNN stereo decoder package, ported ESS workflows away from GXF and updated FoundationStereo workflows to use the new decoder
